...
root.title('DESCARGA DOCUMENTOS DEL COSTE CONTROL')
root.geometry('800x400+10+10')
 
## Crea una etiqueta.
Label(root, text='DESCARGA DOCUMENTOS DEL COSTE CONTROL').pack(pady=10)
 
## Crea un entry.
e=Entry(root,bg="lightyellow")
## Establece el focus en el entry.
e.focus()
e.pack()

## Crea un entry.
a=Entry(root,bg="lightyellow")
## Establece el focus en el entry.
a.focus()
a.pack()
...
Button(root,text="SIGUIENTE", command=hija).pack()
